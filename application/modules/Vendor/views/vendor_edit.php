        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12"> 
                <div class="card">
					...
					<form action="<?= site_url('Vendor/vendor_edit/' .$id); ?>" method="post"
							...
							<div class="col-md-8">
								<div class="col-lg-12 col-md-12">
									<div class="row">
										...
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'vcodeNo', 'value' => set_value('vcodeNo', $vinfo->vcodeNo), 'class' => 'form-control')); ?>
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										<div class="form-group col-md-4"><label>Name:<span
															style="color:red;">*</span></label></div>
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'vname', 'value' => set_value('vname', $vinfo->vname), 'class' => 'form-control', 'placeholder' => 'Vendor Name', 'required' => 'required')); ?>
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										<div class="form-group col-md-4"><label>Phone:<span
															style="color:red;">*</span></label></div>
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'vphone', 'value' => set_value('vphone', $vinfo->vphone), 'class' => 'form-control', 'placeholder' => 'Phone', 'required' => 'required')); ?>
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										...
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'vemail', 'value' => set_value('vemail', $vinfo->vemail), 'class' => 'form-control', 'placeholder' => 'Email')); ?>
							...
							<div class="col-md-4">
								...
								<div class="card shadow"> 
									<div class="card-body"> 
										...
										<input type="file" name="vendor_img" class="dropify" data-default-file="<?= base_url()?>upload/vendors/<?= $vinfo->image;?>">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12"> 
								<div class="form-group"> 
									...
									<?= form_textarea(array('name' => 'vaddress', 'value' => set_value('vaddress', $vinfo->vaddress), 'placeholder' => 'Enter Address', 'colls' => '9', 'rows' => '4', 'class' => 'form-control')); ?>
