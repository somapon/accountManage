										...
										<div class="table-responsive">
												...
												<table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="key-act-button_info">
													...
													<tbody>
														...
														<td class="sorting_1"><?= $val->vcodeNo;?></td>
														<td><?= $val->vname;?></td>
														<td><?= $val->vphone;?></td>
														<td><?= $val->vemail;?></td>
														<td><?= $val->vaddress;?></td>
														<td>
																																												<div class="btn-group align-top">
																																													<a class="btn btn-sm btn-primary badge" title="Edit" href="<?= site_url('Vendor/vendor_edit/' . $val->id); ?>" class="btn btn-primary btn-xs">
																																														<i class="feather icon-edit-1"></i>
																																													</a>
																																													<a class="btn btn-sm btn-primary badge" title="Edit" href="<?= site_url('Vendor/vendor_view/' . $val->id); ?>" class="btn btn-primary btn-xs">
																																														<i class="feather icon-eye"></i>
																																													</a>
																																													<a href="<?= site_url('Vendor/delete_vendor/' . $val->id); ?>" class="btn btn-sm btn-primary badge" onclick="return confirm('Are you sure you want to Remove?');"><i class="feather icon-trash-2"></i></a>
																																												</div>
