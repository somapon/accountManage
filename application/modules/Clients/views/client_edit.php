        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12"> 
                <div class="card">
					...
					<form action="<?= site_url('Clients/client_edit/' .$id); ?>" method="post"
							...
							<div class="col-md-8">
								<div class="col-lg-12 col-md-12">
									<div class="row">
										...
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'ccodeNo', 'value' => set_value('ccodeNo', $cinfo->ccodeNo), 'class' => 'form-control')); ?>
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										<div class="form-group col-md-4"><label>Name:<span
															style="color:red;">*</span></label></div>
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'cname', 'value' => set_value('cname', $cinfo->cname), 'class' => 'form-control', 'placeholder' => 'Vendor Name', 'required' => 'required')); ?>
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										<div class="form-group col-md-4"><label>Phone:<span
															style="color:red;">*</span></label></div>
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'cphone', 'value' => set_value('cphone', $cinfo->cphone), 'class' => 'form-control', 'placeholder' => 'Phone', 'required' => 'required')); ?>
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										...
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'cemail', 'value' => set_value('cemail', $cinfo->cemail), 'class' => 'form-control', 'placeholder' => 'Email')); ?>
							...
							<div class="col-md-4">
								...
								<div class="card shadow"> 
									<div class="card-body"> 
										...
										<input type="file" name="vendor_img" class="dropify" data-default-file="<?= base_url()?>upload/clients/<?= $cinfo->image;?>">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12"> 
								<div class="form-group"> 
									...
									<?= form_textarea(array('name' => 'caddress', 'value' => set_value('caddress', $cinfo->caddress), 'placeholder' => 'Enter Address', 'colls' => '9', 'rows' => '4', 'class' => 'form-control')); ?>
