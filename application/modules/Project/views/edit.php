				...
				<div class="row">
					<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12"> 
						<div class="card">
							...
							<form action="<?= site_url('Project/edit_project/' . $id); ?>" method="post"
										...
										<div class="col-lg-12 col-md-12">
											<div class="row">
												...
												<div class="form-group col-md-8">
													<?= form_input(array('name' => 'project_name', 'value' => set_value('project_name', $p->project_name), 'class' => 'form-control', 'placeholder' => 'Project Name', 'required' => 'required')); ?>
										...
										<div class="col-lg-12 col-md-12"> 
											<div class="row">
												...
												<div class="form-group col-md-4"><label>Description:<span
																style="color:red;">*</span></label></div>
												<div class="form-group col-md-8">
												<?= form_textarea(array('name' => 'description', 'value' => set_value('description', $p->description), 'placeholder' => 'Project Description', 'colls' => '9', 'rows' => '4', 'class' => 'form-control')); ?>
											...
											<div class="row">
												...
												<div class="form-group col-md-8">
													<div class="input-daterange input-group" id="datepicker_range">
														...
														<input type="text" name="start_date" value="<?= set_value('start_date', $p->start_date);?>" class="form-control text-left" placeholder="Start date">
														<input type="text" name="end_date" value="<?= set_value('end_date', $p->end_date);?>"class="form-control text-right" placeholder="End date">
													</div>
