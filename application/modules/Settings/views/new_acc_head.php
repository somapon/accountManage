        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12"> 
                <div class="card">
					...
					<form action="<?= site_url('Settings/add_account_head'); ?>" method="post"
								...
								<div class="col-lg-12 col-md-12">
									<div class="row">
										...
										<div class="form-group col-md-6">
											<?= form_input(array('name' => 'head_title', 'value' => set_value('head_title'), 'class' => 'form-control', 'placeholder' => 'Head Title', 'required' => 'required')); ?>
